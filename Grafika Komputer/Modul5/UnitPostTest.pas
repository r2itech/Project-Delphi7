...
type
  Matrik44 = array[1..4,1..4] of Real;Matrik4N = array[1..4,1..20] of Real;
  TForm1 = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    ...
    procedure ButtonObyekClick(Sender: TObject);
...
procedure MatrikTranslasiSumbuZ(var R : Matrik44; sudut: real);
var radian : real;
begin
